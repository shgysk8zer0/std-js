...
export function createAddressBookIcon({
	...
	return createSVG({
		viewBox: [0, 0, 16, 16],
		height: size, width: parseInt(16 * (size / 16)), fill, classList, part, animation, ...rest,
		children: [
...
export function createBellIcon({
	...
	return createSVG({
		viewBox: [0, 0, 14, 16],
		height: size, width: parseInt(14 * (size / 16)), fill, classList, part, animation, ...rest,
		children: [
...
export function createFileIcon({
	...
	return createSVG({
		viewBox: [0, 0, 12, 16],
		height: size, width: parseInt(12 * (size / 16)), fill, classList, part, animation, ...rest,
		children: [
