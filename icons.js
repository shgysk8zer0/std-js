...
export function createAddressBookIcon({
	...
	return createSVG({
		viewBox: [0, 0, 16, 16],
		height: size, width: 16 * parseInt(size / 16), fill, classList, part, animation, ...rest,
		children: [
...
export function createBellIcon({
	...
	return createSVG({
		viewBox: [0, 0, 14, 16],
		height: size, width: 14 * parseInt(size / 16), fill, classList, part, animation, ...rest,
		children: [
...
export function createFileIcon({
	...
	return createSVG({
		viewBox: [0, 0, 12, 16],
		height: size, width: 12 * parseInt(size / 16), fill, classList, part, animation, ...rest,
		children: [
